...
})(["width:100%;height:calc(100vh - 60px);box-sizing:border-box;padding:10px;position:fixed;top:60px;right:0;background:white;border:1px solid ", ";border-right:none;border-top:none;transform:translateX(", ");transition:transform 0.5s;@media (min-width:650px){width:80%;}@media (min-width:800px){width:60%;}"], function (props) {
...
//# sourceMappingURL=index.js.1109c3d0796e6682f7d8.hot-update.js.map