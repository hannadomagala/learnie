...
})(["width:40vw;padding:10px;position:absolute;top:59px;right:0;background:white;border:1px solid ", ";"], function (props) {
...
})(["border:1px solid ", ";border-radius:10px;padding:7px;outline:none;position:relative;box-sizing:border-box;width:100%;transition:width 0.4s ease-in;&::placeholder{color:", ";font-weight:500;}"], function (props) {
  return props.theme.shadowColor;
}, function (props) {
...
//# sourceMappingURL=index.js.4e924cdfbaf73165c1c7.hot-update.js.map