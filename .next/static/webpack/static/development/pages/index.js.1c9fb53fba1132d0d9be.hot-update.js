...
})(["width:40vw;padding:10px;position:absolute;top:60px;right:0;background:red;"]);
...
})(["border:1px solid ", ";border-radius:10px;padding:7px;outline:none;position:relative;box-sizing:border-box;width:100%;transition:width 0.4s ease-in;&::placeholder{color:", ";font-weight:600;}&:focus{width:70vw;@media (min-width:350px){width:40vw;}@media (min-width:700px){width:20vw;}}"], function (props) {
...
//# sourceMappingURL=index.js.1c9fb53fba1132d0d9be.hot-update.js.map