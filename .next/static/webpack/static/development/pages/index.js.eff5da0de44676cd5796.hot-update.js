...
})(["border:1px solid ", ";border-radius:10px;padding:", ";outline:none;box-sizing:border-box;width:", ";transition:box-shadow 0.2s ease-in;&:focus{box-shadow:", ";}&::placeholder{font-weight:400;}"], function (props) {
  return props.theme.shadowColor;
}, function (props) {
...
var StyledLabel = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].label.withConfig({
  displayName: "add-bar__StyledLabel",
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(AddBar, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(Bar, {
        ...
        wide: true
      }), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(Wrapper, null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(CategoryColor, null), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(StyledSelect, {
        ...
        value: "HTML"
      }, "HTML")), subcategoryChoice), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(Wrapper, null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(AddCategory, {
        onClick: this.onNewCategoryClick
      }, "+ ", isNewCategoryOpen ? 'Existing category' : 'New category'), !this.state.isNewCategoryOpen && react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(AddCategory, {
        onClick: this.onNewSubcategoryClick
      }, "+", ' ', isNewSubcategoryOpen ? 'Existing subcategory' : 'New subcategory'))), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(StyledLabel, null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(SubmitInput, {
        type: "submit",
        value: ""
...
//# sourceMappingURL=index.js.eff5da0de44676cd5796.hot-update.js.map