...
})(["border:1px solid ", ";border-radius:10px;padding:7px;outline:none;position:relative;box-sizing:border-box;width:100%;transition:border 0.4s ease-in;&:focus{border:1.5px solid ", ";}&::placeholder{color:", ";font-weight:500;}"], function (props) {
  return props.theme.shadowColor;
}, function (props) {
...
//# sourceMappingURL=index.js.2bd4d5d0e0932a9e3db0.hot-update.js.map