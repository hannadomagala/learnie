...
})(["background:", ";width:50px;height:50px;border-radius:50%;display:flex;justify-content:center;align-items:center;box-shadow:", ";margin:5px;"], function (props) {
  return props.theme.themeColor;
}, function (props) {
  return props.theme.classicShadow;
});
var externalIconStyle = {
  width: 'auto',
  height: '20px',
  padding: '10px'
}; //component
...
//# sourceMappingURL=index.js.c7f8162b380aac8fdee1.hot-update.js.map