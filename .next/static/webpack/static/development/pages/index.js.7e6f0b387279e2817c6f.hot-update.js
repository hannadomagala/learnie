...
})(["width:100%;box-sizing:border-box;border:1px solid ", ";box-shadow:", ";padding:20px;margin:15px 3px;line-height:1.25em;@media (min-width:500px){width:49%;}@media (min-width:1100px){width:32%;}@media (min-width:1450px){width:24%;}"], function (props) {
...
//# sourceMappingURL=index.js.7e6f0b387279e2817c6f.hot-update.js.map