...
})(["width:100%;height:calc(100vh - 60px);box-sizing:border-box;padding:10px;position:fixed;top:60px;right:0;background:white;border:1px solid ", ";border-right:none;border-top:none;transform:translateY( ", " );transition:transform 0.5s;@media (min-width:650px){width:80%;}"], function (props) {
  return props.theme.shadowColor;
}, function (props) {
  return props.isOpen ? 0 : 'calc((100vh - 60px) * (-1))';
});
...
//# sourceMappingURL=index.js.32a6d38c8e9128c54b44.hot-update.js.map